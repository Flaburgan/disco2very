...
import { DragDropContext, DropResult } from "../lib/dnd";
import { GameState } from "../types/game";
import useAutoMoveSensorVanilla from "../lib/useAutoMoveSensorVanilla";
...
export default function Board(props: Props) {
  ...
  return (
    <DragDropContext
      ...
      sensors={[useAutoMoveSensorVanilla(state)]}
    >
      <div
        className={
          styles.wrapper + " " + (isDragging ? "dragging" : "notDragging")
        }
      >
